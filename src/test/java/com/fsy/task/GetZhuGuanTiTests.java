...
public class GetZhuGuanTiTests {
...
//        Map map = new HashMap();
//        final HashMap<String,String> ZhuGuanMap = elements.parallelStream()
//                .filter((Element::hasText))
//                .collect(Collectors.toMap(ele -> ele.text(), ele -> ele.attr("id"), (a, b) -> b, (Supplier<HashMap<Object, Object>>) HashMap::new));
